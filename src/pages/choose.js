...
export default function Choose() {
  ...
  return (
    <>
      <motion.section
        id="chooseSection"
        className="bg-[#F2F2F2] text-center font-sans min-h-full m-0 mt-48px md:mt-[56px] md:px-[32px] py-[24px] md:py-[32px] px-24px text-[#333333]"
        initial="hidden"
        ...
        >
          ...
          <div className="max-w-[600px] text-left md:max-w-[500px]">
            ...
            <ol className="md:pl-4 md:pr-20 font-light tracking--2 mb-8 space-y-4 text-fluid-caption mt-12px">
              ...
              <li>
                2. Future-proof scaling: Grow from single store POS to a full
                ERP suite, no re-implementation.
              </li>
              <li>
                3. Total control: See your data, operations, and compliance in
                real time.
              </li>
            </ol>
          </div>
      ...
      <motion.section
        id="readySection"
        className=" my-48px md:my-[56px] md:px-[32px] px-24px text-center min-h-full text-[#333333] mt-8"
        initial="hidden"
        animate={isVisible ? "visible" : "hidden"}
      >
        <motion.h2
